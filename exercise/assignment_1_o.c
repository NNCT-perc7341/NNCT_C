...
int vol(int num1, int num2){
  ...
  /*if (num1 <= 200) {
    if (num2 <= 3) num1 = num1 - 10;
    num = 120 * num1;
  } else if (num1 > 200 && num1 <= 500 && num2 > 3) {
    num = 24000 + 105 * (num1 - 200);
  } else if (num1 > 500 && num1 <= 5000 && num2 > 3) {
    num = 24000 + 31500 + 95 * (num1 - 500);
  } else if (num1 > 200 && num1 <= 500 && num2 <= 3) {
    num = 22800 + 105 * (num1 - 200);
  } else if (num1 > 500 && num1 <= 5000 && num2 <= 3) {
    num = 22800 + 31500 + 95 * (num1 - 500);
  } else if (num2 <= 3){
    num = 22800 + 31500 + 427500 + 90 * (num1 - 5000);
  } else {
    num = 24000 + 31500 + 427500 + 90 * (num1 - 5000);
  } */
